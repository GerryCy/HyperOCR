...
default.root_path = r'/run/user/0/VOCdevkit/VOC2007'
default.dataset_path = r'/run/user/0/VOCdevkit/VOC2007'
# default training
default.frequent = 20
...
network.mobilenet= edict()
network.mobilenet_text = edict()
